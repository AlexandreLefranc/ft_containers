...
/*   Updated: 2023/01/04 16:05:42 by alefranc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	private: // node
		...
		struct Node
		{
			...
			Node(int val = 0, Color color = BLACK, Node *left = NULL,
	...
	private: // modifers helper
		...
		node_pointer _erase(node_pointer node)
		{
			if (node->left == NULL || node->right == NULL)
			{
				...
				{
					node->color = (child != NULL && child->color == Color::RED) ?
		...
		void _erase_fixup(node_pointer node)
		{
			...
			while (node != _root && (node == NULL || node->color == Color::BLACK))
			{
	...
	public: // operation
		...
		iterator lower_bound(const key_type& k)
		{
			...
			return lower != NULL ? iterator(lower, this) : end();
		}
		...
		const_iterator lower_bound(const key_type& k) const
		{
			...
			return lower != NULL ? const_iterator(lower, this) : end();
		}
		...
		iterator upper_bound(const key_type& k)
		{
			...
			return upper != NULL ? iterator(upper, this) : end();
		}
		...
		const_iterator upper_bound(const key_type& k) const
		{
			...
			return upper != NULL ? const_iterator(upper, this) : end();
		}
